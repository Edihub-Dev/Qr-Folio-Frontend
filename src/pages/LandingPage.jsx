            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="text-center">
                ...
                >
                  ...
                  <p className="text-gray-300 hover:text-white transition">
                    Floor No.: SECOND FLOOR Building, No./Flat No.: 208,
                    Building: Royal Essence Road/Street: Unnamed Road, Nearby
                    Landmark: St John The Baptist Church Locality/Sub, Locality:
                    Lalarpura, District: Jaipur, State: Rajasthan, PIN Code:
                    302021
                  </p>
                </a>
              </div>
